  ...
  if (done) {
    return (
      <div className="min-h-screen bg-[#050708] flex items-center justify-center px-6">
        ...
        >
          <div className="w-16 h-16 rounded-full bg-[#00D4FF]/10 border border-[#00D4FF]/30 flex items-center justify-center mx-auto mb-6">
          ...
          <p className="text-[#93A29E] leading-relaxed">
      ...
      >
        ...
        <div className="p-8 bg-[#0A0D0F] border border-white/8 rounded-2xl">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            {/* Anonymous toggle */}
            <div className="flex items-center justify-between p-4 rounded-xl bg-[#050708] border border-white/10">
              <div className="flex items-center gap-3">
                <Shield className="w-4 h-4 text-[#00D4FF]" />
                <div>
                  <div className="text-sm font-semibold">Stay Anonymous</div>
                  <div className="text-xs text-[#93A29E]">Use a random username</div>
                </div>
              </div>
              <Switch
                checked={anonymous}
            ...
            {!anonymous && (
              <div className="space-y-2">
                <label className="text-xs font-semibold text-[#93A29E] uppercase tracking-wider">Display Name</label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#93A29E]" />
                  <Input
                    value={displayName}
                    onChange={e => setDisplayName(e.target.value)}
                    placeholder="Your name"
                    className="pl-10 bg-[#050708] border-white/10 focus:border-[#00E599]/50"
                  />
                </div>
              </div>
            )}
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-[#93A29E] uppercase tracking-wider">Email</label>
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#93A29E]" />
                <Input
                  type="email"
                  value={email}
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-[#93A29E] uppercase tracking-wider">Password</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#93A29E]" />
                <Input
                  type={showPassword ? 'text' : 'password'}
                  value={password}
                  onChange={e => setPassword(e.target.value)}
                  placeholder="Min. 8 characters"
                  className="pl-10 pr-10 bg-[#050708] border-white/10 focus:border-[#00E599]/50"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#93A29E] hover:text-white transition-colors"
                >
          ...
          <p className="text-center mt-6 text-sm text-[#93A29E]">
            Already have an account?{' '}
            <Link href="/auth/login" className="text-[#00E599] hover:text-[#14E5C8] transition-colors">Sign in</Link>
          </p>
        </div>

        <p className="text-center mt-6 text-xs text-[#93A29E]">

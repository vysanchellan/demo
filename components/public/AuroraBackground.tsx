  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(255,122,107,0.22) 0%, transparent 65%)' }}
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full opacity-[0.08] animate-rotate-slow"
        style={{ background: 'conic-gradient(from 0deg, transparent, #FF7A6B, transparent, #2DD4BF, transparent, #2DD4BF, transparent)' }}
      />
